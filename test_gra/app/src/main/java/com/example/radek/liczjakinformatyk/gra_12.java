...
public class gra_12 extends AppCompatActivity {

    private static final int LICZBA_PRZYCISKOW = 9;
    private static final long START_CZASU = 90000;
    private static final int ZAKRES_LICZBY = 4095;
