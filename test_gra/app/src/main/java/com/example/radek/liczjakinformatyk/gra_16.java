...
public class gra_16 extends AppCompatActivity {


    private static final int LICZBA_PRZYCISKOW = 9;
    private static final long START_CZASU = 60000*2;
    private static final int ZAKRES_LICZBY = 65535;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gra_4);

        Log.d("gra_16","onCreate");
