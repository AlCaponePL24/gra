...
public class menu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rankingi = (Button) findViewById(R.id.rankingi);
        ...
        rankingi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openRankings();
            }
    ...
    public void opengra_4(){
        Intent intent = new Intent( this, gra_4.class);
    ...
    public void openRankings() {
        Intent intent = new Intent(this, WyborRankingow.class);
        startActivity(intent);
    }
